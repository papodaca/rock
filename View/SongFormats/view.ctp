<div class="songFormats view">
<h2><?php  echo __('Song Format'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($songFormat['SongFormat']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($songFormat['SongFormat']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($songFormat['SongFormat']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($songFormat['SongFormat']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Song Format'), array('action' => 'edit', $songFormat['SongFormat']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Song Format'), array('action' => 'delete', $songFormat['SongFormat']['id']), null, __('Are you sure you want to delete # %s?', $songFormat['SongFormat']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($songFormat['Song'] as $song): ?>
		<tr>
