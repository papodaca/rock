define ["backbone", "underscore", "notifier", "hbs!template/LibraryModal", "models/LibraryModel", "Util", "jquery", "jquery.bootstrap"], (Backbone, _, Notifier, Template, LibraryModel, Util, $, BS) ->
